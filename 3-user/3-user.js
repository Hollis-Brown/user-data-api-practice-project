// Using async and await and promise.any() using the fetch() API to perform networking in JavaScript to fetch cities data
...
Promise.any([promise1, promise2])
 .then(function(data) {
    console.log("Data received for either promise");
    list.innerHTML = data;
})
.catch(function(error) {
